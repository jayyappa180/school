  ...
  storeTenant(tenant) {
    ...
    return new Promise((resolve, reject) => {
      connectionPool.query(
        storeProc,
        [tenant.name, tenant.email, tenant.phone, tenant.address, tenant.state, tenant.district, tenant.pincode,tenant.code, 0, 0, 0, '2020-06-21 01:02:03', 1, '2020-06-21 01:02:03', 1],
        (error, response) => {

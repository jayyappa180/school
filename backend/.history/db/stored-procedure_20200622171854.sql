...
BEGIN
    ...
    SELECT COUNT(b.name) INTO  v_branch_record_count FROM branch b WHERE b.name = name AND b.email = emal AND b.phone = phone;
    ...
    THEN
        ...
        INSERT INTO branch (tenant_id, name, code, verified, status, subscribed, created_date, created_by, updated_date, updated_by) 
